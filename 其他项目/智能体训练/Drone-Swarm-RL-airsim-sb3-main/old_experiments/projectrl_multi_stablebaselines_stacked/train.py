...
model = PPO(
    'MultiInputPolicy', 
    env, 
    learning_rate=0.0001, #0.00005, 0.00003, 0.00001
    batch_size=256,
    clip_range=0.1,
    verbose=1, 
    seed=42,
...
# model = PPO.load("saved_policy/best_model", custom_objects = custom_objects, tensorboard_log="tb_logs\ppo_run_1693982125.4322813_1", env=env)
